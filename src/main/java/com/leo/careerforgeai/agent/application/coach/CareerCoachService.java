...
public final class CareerCoachService {
    ...
    private static final int MAX_USER_MESSAGE_CHARS = 12_000;
    private static final String CONTEXT_VERSION = "career-coach-native-v1|prompt=1|tools=1";
    ...
    public CareerCoachService(
            ...
            KnowledgeSourceProperties sourceProperties
    ) {
        ...
        this.serverRetrievalScope = new RetrievalScope(
    ...
    public CareerCoachResult coach(String message) {
        ...
        AgentLoopRequest loopRequest = new AgentLoopRequest(
                List.of(
                        new ToolCallingTextMessage(ModelRole.SYSTEM, SYSTEM_PROMPT),
